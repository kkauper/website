...
function KAUPERCO() {
  this.init = function () {
    this.initPreloader();
    this.initPageExit(); // NAV MOUSE HOVER CLASS

    this.initNavHoverCursor(); // OVERLAY NAVIGATION

    this.initShowOverlayNavigation();
    this.initHideOverlayNavigation(); // INIT LAX.JS

    this.initWow(); // INIT HOME FADE

    this.initHeroFade(); // INIT ARCHIVE SCROLLING
